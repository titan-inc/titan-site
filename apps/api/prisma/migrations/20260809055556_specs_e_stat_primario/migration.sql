...
-- AlterTable
ALTER TABLE "CatalogItem" ADD COLUMN     "primaryStats" "PrimaryStat"[],
ADD COLUMN     "specsCuratedAt" TIMESTAMP(3);

-- CreateTable
CREATE TABLE "CatalogItemSpec" (
    "itemId" INTEGER NOT NULL,
    "spec" "WowSpec" NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "CatalogItemSpec_pkey" PRIMARY KEY ("itemId","spec")
);

-- CreateIndex
CREATE INDEX "CatalogItemSpec_spec_idx" ON "CatalogItemSpec"("spec");

-- AddForeignKey
ALTER TABLE "CatalogItemSpec" ADD CONSTRAINT "CatalogItemSpec_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "CatalogItem"("itemId") ON DELETE CASCADE ON UPDATE CASCADE;
