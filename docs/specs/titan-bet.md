...
> a D-49. Mercado sem resultado premiável redistribui em vez de VOID (D-61, substitui a
> D-06 para os casos calculados). Vários `titanbet*` por sessão (D-63, substitui a escolha
> do officer da D-25).
>
...
| D    | Resolve | Decisão                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ---- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D-53 | OQ-56   | **(a)** Quem estava no `BetRoundBettor` no Ready mantém acesso à **própria rodada e à própria aposta** mesmo saindo da guilda — acesso específico daquela rodada, sem membership no resto do site. **(b)** Membro atual da guilda fora do snapshot **vê mercados e odds**; só não cria, salva nem submete aposta.                                                                                                                                                                                     |
| D-54 | OQ-55   | **Weekly Progression simplificada — mudança de produto.** Só encounters **Progression** no Ready participam; bosses **Farm** ficam fora. Cada boss de progressão é uma **opção**: "este boss será morto pela primeira vez nesta semana?". Cada boss tem a sua parte da pool, a sua odd projetada (ao lado do nome, como as dos candidatos) e o seu resultado. **Não existe mais aposta em conjunto exato de 0..N bosses nem cálculo por `K`.** Substitui D-05, D-15, a parte Weekly da D-28 e a D-49. |
| D-55 | OQ-04a  | **Qualquer personagem do apostador pode depositar**, sem precisar estar ligado como `GuildCharacter`. O membro informa o personagem; ele fica congelado no slip submetido; **a conferência de que ele é do apostador é do officer** na confirmação do depósito.                                                                                                                                                                                                                                       |
| D-56 | OQ-27a  | **Nenhum personagem reconhecido como do apostador pode ser alvo do seu First Death** — não só o depositante.                                                                                                                                                                                                                                                                                                                                                                                          |
| D-57 | OQ-48   | **"Ver slip" no Officer Panel**, para disputa: o slip exatamente como foi submetido, **somente leitura**, e cada acesso registrado em `BetEvent` com o officer e o horário. Nenhuma alteração por essa superfície.                                                                                                                                                                                                                                                                                    |
| D-58 | OQ-28   | **Officer pode confirmar o próprio depósito.** Sem bloqueio especial.                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| D-59 | OQ-54   | **Slip recusado não tem fluxo financeiro de restituição.** A feature só rejeita a aposta; devolução de gold depositado é resolvida pelo officer fora do Titan Bet, pelo log do jogo.                                                                                                                                                                                                                                                                                                                  |
| D-60 | OQ-45   | O officer pode declarar **"não houve raid oficial nesta sessão"**, com motivo. A sessão fica resolvida, **sem pulls**; a outra sessão segue normal. Ausência de `titanbet*` **nunca** infere isso sozinha.                                                                                                                                                                                                                                                                                            |
| D-61 | OQ-50   | **Sem settlement parcial**: a rodada é resolvida inteira e liquidada uma vez. Mercado **sem resultado premiável** na semana tem o prize pool **redistribuído igualmente entre os demais premiáveis**, como o `W = 0` (D-44); os 10% seguem a regra normal. **VOID fica para o que realmente exige restituição**, não para "o boss não morreu". Sem premiável para receber, para e pede decisão.                                                                                                       |
| D-62 | OQ-40   | Várias kills válidas do mesmo boss na semana: **vale a primeira, cronologicamente**; as outras não produzem resultado.                                                                                                                                                                                                                                                                                                                                                                                |
| D-63 | OQ-39   | **Todos os `titanbet*` válidos da sessão** são fonte — uma timeline consolidada, não um report escolhido. Boss com kill: a primeira kill cronológica. Progressão sem kill: as pulls de todos os reports, com a **mesma try em reports diferentes contada uma vez**, identificada pelo **início absoluto** da fight — nunca pela hora do dia. Substitui a escolha do officer na D-25.                                                                                                                  |
| D-64 | OQ-46   | **Farm/Progression não é validado contra o WCL.** Vale o que o officer declarou e o Ready congelou.                                                                                                                                                                                                                                                                                                                                                                                                   |
| D-65 | OQ-03   | Quem perde membership depois do Ready **continua concorrendo** na rodada e tem direito a prêmio e restituição (coerente com D-53).                                                                                                                                                                                                                                                                                                                                                                    |
| D-66 | OQ-30   | **Nenhuma notificação no Discord agora.** Fica como possibilidade de sprint futuro de melhorias.                                                                                                                                                                                                                                                                                                                                                                                                      |

**Leituras de implementação (registradas para revisão):**

1. **D-54:** a Weekly continua **um** mercado da rodada, e a aposta continua **uma por mercado** (D-28): o membro escolhe **um** boss de progressão, com um stake. Bosses mortos na semana são as opções vencedoras (vários mortos = empate, R-20). Nenhum boss de progressão morto → mercado sem resultado premiável (D-61).
2. **D-61:** vale para **todo "sem vencedor" calculado** — sem kill, sem pull, sem candidato elegível —, o que tira da D-06 o caso "nenhuma opção elegível produz resultado vencedor". Nenhum caminho automático produz mais `VOID`; o desfecho `anulado` continua no modelo para o que exigir restituição, mas hoje nada o gera.
3. **D-63:** a identidade temporal é **mesmo encounter + início absoluto a menos de 10 s** (§15.8: cópias da mesma pull diferem 0,3–3,7 s entre reports; pulls diferentes do mesmo boss, no mínimo 46 s). Igualdade exata nunca deduplicaria nada.
4. **D-53a:** o sistema reconhece o ex-membro pela **posse de um slip na rodada**; o elegível que sai da guilda **antes** de criar qualquer slip perde a ligação conta ↔ personagem (o `GuildCharacter` é apagado na revalidação) e não consegue começar um. Resolver isso exige guardar os personagens da conta fora do roster — mudança no login, fora do Titan Bet.
...
| D-52 | —       | **Closing Report, três regras aprovadas.** (1) O **total devido** é o resultado financeiro devido ao membro na rodada e **não muda com o pagamento físico** — pagar não gera versão nova do relatório. (2) Mercado `VOID` aparece com o motivo, **sem identificar quem apostou nele**; a restituição entra só no total agregado do membro — por isso o total **não é só winnings**: é prêmios + restituições (+ ajustes). (3) Quem só perdeu, sem prêmio nem restituição, não aparece no resumo financeiro. |
...
| 9       | OQ-57 (D-44) · OQ-25 parse (D-43)                                                                                                                                                                                 |
| 10      | OQ-25 métricas (D-47) · OQ-51 (D-48) · OQ-47 (D-49) · OQ-52 (D-50) · OQ-34 (D-51)                                                                                                                                 |
| 11      | OQ-56 (D-53) · OQ-55 (D-54) · OQ-04a (D-55) · OQ-27a (D-56) · OQ-48 (D-57) · OQ-28 (D-58) · OQ-54 (D-59) · OQ-45 (D-60) · OQ-50 (D-61) · OQ-40 (D-62) · OQ-39 (D-63) · OQ-46 (D-64) · OQ-03 (D-65) · OQ-30 (D-66) |
| 7       | OQ-53 (D-38)                                                                                                                                                                                                      |
