...
| `BetMarket`          | `(kind = 'weekly_progression') = (roundEncounterId IS NULL)`; `track = 'progressao' ⇒ kind = 'first_death'`                                                                                                                                                                              |
...
| `BetAuditSource`     | `resolution ∈ (automatica, escolha_officer) ⇒ reportCode NOT NULL`; `escolha_officer ⇒ resolvedBy* NOT NULL`                                                                                                                                                                             |
